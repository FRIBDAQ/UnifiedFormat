...
namespace ufmt {
    ...
    */
    ...
    {
        ::ufmt::CGlomParameters::TimestampPolicy ePolicy =
            static_cast<::ufmt::CGlomParameters::TimestampPolicy>(policy);
    ...
    RingItemFactory::makeGlomParameters(const ::ufmt::CRingItem& rhs)
    {
        if (rhs.type() == v11::EVB_GLOM_INFO) {
            ...
            return new v11::CGlomParameters(
                ...
                static_cast<::ufmt::CGlomParameters::TimestampPolicy>(pGlom->s_timestampPolicy)
            );
        } else {
            throw std::bad_cast();
        }
     ...
     * @return ::ufmt::CPhysicsEventItem* - actually pointing at a v11::CPhysicsEventItem.
     */
     ...
     *  @return ::ufmt::CPhysicsEventItem* - actuall points to a v11::CPhysicsEventItem.
     */
    ::ufmt::CPhysicsEventItem*
     ...
     *  @return ::ufmt::CRingFramentItem*  - pointer to an v11::CRingFragmentItem.
     */
    ...
    RingItemFactory::makeRingFragmentItem(const ::ufmt::CRingItem& rhs)
    {
        if (rhs.type() == v11::EVB_FRAGMENT) {
            ...
            return reinterpret_cast<::ufmt::CRingFragmentItem*>(makeUnknownFragment(rhs));
        } else {
            throw std::bad_cast();
        }
    }
    ...
    */
     ...
     *               scaler item.
     *  @return ::CRingScalerItem* - actually points to a v11::ufmt::CRingScalerItem.
     ...
     */
    ::ufmt::CRingScalerItem*
    RingItemFactory::makeScalerItem(const ::ufmt::CRingItem&  item)
    {
